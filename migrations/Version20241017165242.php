 ...
 */
final class Version20241017165242 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE realisation (id SERIAL NOT NULL, categorie_id INT DEFAULT NULL, titre VARCHAR(255) NOT NULL, description VARCHAR(500) NOT NULL, lien_github VARCHAR(255) NOT NULL, image VARCHAR(255) NOT NULL, techno_use VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
