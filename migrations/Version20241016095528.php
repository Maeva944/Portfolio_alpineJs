...
final class Version20241016095528 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE realisation RENAME COLUMN id_categorie TO categorie_id');
        $this->addSql('ALTER TABLE realisation ADD CONSTRAINT FK_EAA5610E9F34925F FOREIGN KEY (categorie_id) REFERENCES categorie (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('CREATE INDEX IDX_EAA5610E9F34925F ON realisation (categorie_id)');
    }
